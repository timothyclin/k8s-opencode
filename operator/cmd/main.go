...
import (
	...
	"github.com/timothyclin/k8s-opencode/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(opencodev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b138afdc.opencode.io",
